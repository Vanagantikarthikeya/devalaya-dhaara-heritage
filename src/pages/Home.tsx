  ...
  return (
    <div className="min-h-screen bg-background">
              ...
              <CardContent className="p-6">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">{t('home.dayStreak')}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="bg-card/50 border-primary/20 backdrop-blur-sm hover:shadow-divine transition-all duration-300">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-xl font-semibold mb-4">{t('home.sacredHeritage')}</h3>
                <p className="text-muted-foreground">
                  {t('home.sacredHeritageDesc')}
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-card/50 border-primary/20 backdrop-blur-sm hover:shadow-divine transition-all duration-300">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-xl font-semibold mb-4">{t('home.livingVoices')}</h3>
                <p className="text-muted-foreground">
                  {t('home.livingVoicesDesc')}
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-card/50 border-primary/20 backdrop-blur-sm hover:shadow-divine transition-all duration-300">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-xl font-semibold mb-4">{t('home.futureGenerations')}</h3>
                <p className="text-muted-foreground">
                  {t('home.futureGenerationsDesc')}
                </p>
              </CardContent>
            </Card>
          </div>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-center mb-12 text-foreground">
            {t('home.hearTheVoices')}
          </h2>
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { type: t('home.audioContributions'), icon: Volume2, count: "1,247", color: "text-accent" },
              { type: t('home.videoContributions'), icon: Video, count: "892", color: "text-primary" },
              { type: t('home.storiesContributions'), icon: FileText, count: "2,156", color: "text-foreground" }
            ].map((item) => (
          ...
          <div className="max-w-2xl mx-auto mb-12">
            ...
            <div className="grid grid-cols-3 gap-8 mb-8">
              <div>
                ...
                <p className="font-semibold">{t('home.yourStoryScripture')}</p>
              </div>
              <div>
                <Star className="mx-auto mb-2 text-accent" size={32} />
                <p className="font-semibold">{t('home.echoFuture')}</p>
              </div>
              <div>
                <Star className="mx-auto mb-2 text-accent" size={32} />
                <p className="font-semibold">{t('home.oneVoice')}</p>
              </div>
            </div>
            <Link to="/upload">
